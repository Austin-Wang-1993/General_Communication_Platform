...
> **文档版本**：v0.1.14  
> **更新时间**：2026-05-14  
> **关联**：`../product/01-中台产品文档.md`（中台 v0.5.13）、`../product/02-前端需求文档.md`（v0.2.14）、`01-技术方案.md`（v0.3.14）、`02-代码架构与目录约定.md`（v0.1.13）  
...
**作用**：P3 **NPC 气泡**「翻」按钮——将**单行英文**转为**简体中文**展示；**不**写入 `turns.jsonl`，**不**改变运行态（中台 **§6.9**）。
...
| P3-11-01「翻」 | `POST /translation/en-to-zh` |
