...
> **文档版本**：v0.1.11  
> **更新时间**：2026-05-14  
> **关联**：`../product/01-中台产品文档.md`（中台 v0.5.9）、`../product/02-前端需求文档.md`（v0.2.10）、`01-技术方案.md`（v0.3.11）、`02-代码架构与目录约定.md`（v0.1.10）  
...
| 版本 | 日期 | 说明 |
|------|------|------|
| v0.1.11 | 2026-05-14 | 头部「关联」版本号：中台 v0.5.9、前端 v0.2.10、技术方案 v0.3.11、代码架构 v0.1.10 |
