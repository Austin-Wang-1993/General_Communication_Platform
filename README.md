...
| 文档 | 路径 | 给谁看 |
|------|------|--------|
| **商业化目录说明** | [`docs/commercial/README.md`](docs/commercial/README.md) | 合伙人、立项讨论：本目录与产品/工程真源的关系 |
| **商业化摘编与立项备忘录** | [`docs/commercial/01-商业化摘编与立项备忘录.md`](docs/commercial/01-商业化摘编与立项备忘录.md) | 价值主张摘要、Demo 边界、未做能力、商业化议题、「为什么没做 / 若要做」 |

> 本目录内容为**摘编与沟通辅助**，**不**新增产品硬规则或接口契约；字段与规则仍以 **中台 / 前端需求 / API** 为准。
...
- **产品经理 / 投资人**：中台产品文档 → 前端需求文档 → **商业化摘编**（[`docs/commercial/01-商业化摘编与立项备忘录.md`](docs/commercial/01-商业化摘编与立项备忘录.md)）→ 技术方案（只看 §1~§3）
- **后端开发**：中台产品文档 → 技术方案 → 代码架构 → API 接口 → 业务流程
- **前端开发**：前端需求文档 → 代码架构（前端部分） → API 接口
- **运维 / 部署**：技术方案 §11
- **合伙人 / 立项沟通**：**商业化摘编** → README 产品一句话 → 中台主线 §4（再按需深入工程文档）
