...
- **P3** `/scenarios/:id/chat`：`GET runtime`、`POST enter`、`POST turns`；首入自动 `enter(S[0])`（**F-P3-00**）；用户绿泡正文上展示「发出方 → 接收方」（**P3-07-09**）；顶栏 **返回首页 / 背景介绍 / 回答提示（R1）/ 总结分析（R2）/ 查看列表**；**选择信息接收人**、P3a 进节
